...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // 4. Get the download URL from firebase storage and update the original post with the image
                        ...
                        overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            <div>
                                ...
                                <div className="mt-5 sm:mt-6">
                                    ...
                                    px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 
